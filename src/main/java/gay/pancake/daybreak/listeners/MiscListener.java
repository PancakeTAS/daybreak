...
public class MiscListener implements Listener {
    ...
    public void onPlayerJoin(PlayerJoinEvent e) {
        e.joinMessage(miniMessage().deserialize("<prefix><gold><player></gold> <red>joined the game</red>", DaybreakPlugin.PREFIX, unparsed("player", e.getPlayer().getName())));
    ...
    public void onPlayerQuit(PlayerQuitEvent e) {
        ...
        e.quitMessage(miniMessage().deserialize("<prefix><gold><player></gold> <red>left the game</red>", DaybreakPlugin.PREFIX, unparsed("player", p.getName())));
    }
    ...
    public void onPlayerDeath(PlayerDeathEvent e) {
        ...
        e.deathMessage(miniMessage().deserialize("<prefix><msg>", DaybreakPlugin.PREFIX, parsed("msg", msg)));
